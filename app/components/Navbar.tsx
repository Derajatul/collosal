  ...
  return( 
    ...
    <nav className="h-[80px] fixed top-0  max-w-6xl w-full md:p-0 px-[20px] bg-[#0B0B22] md:hidden">
     ...
     <div className={`flex flex-col ${isOpen ? 'block' : 'hidden'}`}>
        ...
        <Link href="#" className="paragraph hover:text-white py-5 bg-[#0B0B22]">How We Work</Link>
        <Link href="/projects" className="paragraph hover:text-white py-5 bg-[#0B0B22]">Projects</Link>
        <Link href="#" className="paragraph hover:text-white py-5 bg-[#0B0B22]">About</Link>
      ...
      {/* Desktop  */}
     <nav className="hidden h-[80px] fixed top-0 md:flex justify-between items-center max-w-6xl w-full px-[20px] bg-[#0B0B22]">
